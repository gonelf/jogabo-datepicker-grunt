...
[![Build Status](https://travis-ci.org/gonelf/jogabo-datepicker.svg?branch=master)](https://travis-ci.org/gonelf/jogabo-datepicker) [![Dependency Status](https://david-dm.org/gonelf/jogabo-datepicker.svg)](https://david-dm.org/gonelf/jogabo-datepicker) [![devDependency Status](https://david-dm.org/gonelf/jogabo-datepicker/dev-status.svg)](https://david-dm.org/gonelf/jogabo-datepicker#info=devDependencies)
...
## Release History
 * 2014-12-09   v0.1.0   Generated by the [Yeoman Generator](https://github.com/FamousTools/generator-famous) for [Famo.us](http://famo.us)